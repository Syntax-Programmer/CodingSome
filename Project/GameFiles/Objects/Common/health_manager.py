...
class Health:
    ...
    def do_healing(self, heal_amount: int) -> None:
        ...
        if heal_amount > self.health_bar:
            heal_amount = self.health_bar
        self.health += heal_amount

    def increase_health_bar(self, new_health_bar: int) -> None:
        """
        This increases or decreases the max health the object can have.

        @param: new_health_bar : int
            The max health in the new health bar.
        """
