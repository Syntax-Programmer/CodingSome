...
def check_ground_collision(
    player_obj: Neutral.Player, terrain_handler: Passive.TerrainHandler
) -> None:
    ...
    for terrain_block in terrain_handler.terrain_group:
...
def main(screen: pygame.Surface) -> None:
    ...
    player = Neutral.Player(
        (0, 600), decode_sprite_sheets_x("Assets\\Characters\\VirtualGuy", (48, 48))
    )
    ...
    while running:
        ...
        check_ground_collision(player, terrain_handler)
