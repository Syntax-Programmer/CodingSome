...
def parse_level_json(
    level_count: int, terrain_handler_obj: Passive.TerrainHandler
    ...
    terrain_handler_obj.add_terrain_blocks(level_data["terrains"])
    return level_data["bg_color"]
...
def main(screen: pygame.Surface) -> None:
    ...
    bg_image_color = parse_level_json(level_count, terrain_handler)
